...
console.log(
  'checkIfIncludes("Hello, world!", "click")',
  checkIfIncludes("Hello, world!", "click")
); // Виведе false
...
console.log(
  'checkIfStartsWith("Hello, world!", "world")',
  checkIfStartsWith("Hello, world!", "world")
); // Виведе false
 ...
 console.log(
  'checkIfEndsWith("Hello, world!", "Hello")',
  checkIfEndsWith("Hello, world!", "Hello")
 ); // Виведе false
  ...
  function compareCharCodeAtAndCodePointAt(string, index) {
    ...
    // Використовуємо метод charCodeAt(), щоб отримати код символа з рядка на певній позиції, та запишемо результат в змінну charCodeAtResult
       const charCodeAtResult = (string.charCodeAt(0));
    // Використовуємо метод codePointAt(), щоб отримати код символа з рядка на певній позиції, та запишемо результат в змінну codePointAtResult
       const codePointAtResult = (string.codePointAt(0));
...
console.log(
 ...
 // Завдання 13: Напишіть функцію, яка буде видаляти пробіли з рядка на початку, в кінці
 // або з обох сторін, в залежності від значення аргументу "side".
 ...
 function sliceString(string, startIndex, endIndex) {
  // Використовуємо метод slice(),
  // щоб видалити частину рядка string між двома індексами startIndex та endIndex
 ...
 function substringString(string, startIndex, endIndex) {
  // Використовуємо метод substring(),
  // щоб видалити частину рядка string між двома індексами startIndex та endIndex
